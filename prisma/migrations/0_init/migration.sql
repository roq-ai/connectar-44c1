...
CREATE TABLE "virtual_item" (
    ...
    CONSTRAINT "virtual_item_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "virtual_item" ADD CONSTRAINT "virtual_item_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
